...
$(".addmore").on('click', function () {
    ...
    html += '<td><input type="hidden" name="itemID[]" id="itemID_' + i + '" class="form-control autocomplete_txt text-right" autocomplete="off"><input type="text" data-type="SKU" name="item[]" id="item_' + i + '" class="form-control autocomplete_txt text-right" autocomplete="off"></td>';
...
//    html += '<td><input type="number" name="hsn[]" id="hsncode_' + i + '" class="form-control changesNo text-right" autocomplete="off" readonly="" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"><input type="number" name="stock[]" id="stock_' + i + '" class="form-control changesNo text-right" autocomplete="off" readonly="" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
    html += '<td><select name="stock[]" id="stock_' + i + '" class="form-control stock" value="0"></select></td>';
...
//    html += '<td><input type="number" name="quantityunit[]" id="quantityunit_' + i + '" class="form-control changesNo text-right" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
    html += '<td><input type="hidden" step="0.01"  name="mrp[]" id="mrp_' + i + '" class="form-control changesNo text-right" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"><input type="number" step="0.01" name="rate[]" id="rate_' + i + '" class="form-control changesNo text-right" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
    html += '<td><input type="number" step="0.01"  name="discount[]" id="discount_' + i + '" class="form-control changesNo text-right" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
    html += '<td><input type="number" step="0.01"  name="taxableamt[]" id="taxableamt_' + i + '" class="form-control changesNo text-right taxableamount" readonly autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
    html += '<td class="cgst"><input type="number" step="0.01" name="cgst[]" id="cgst_' + i + '" class="cgstval form-control changesNo text-right" readonly autocomplete="off"  ondrop="return false;" onpaste="return false;">@(<span name="cgstrate[]" id="cgstrate_' + i + '"></span>)</td>';
    html += '<td class="sgst"><input type="number" step="0.01" name="sgst[]" id="sgst_' + i + '" class="sgstval form-control changesNo text-right" readonly autocomplete="off"  ondrop="return false;" onpaste="return false;">@(<span name="sgstrate[]" id="sgstrate_' + i + '"></span>)</td>';
    html += '<td class="igst"><input type="number" step="0.01" name="igst[]" id="igst_' + i + '" class="igstval form-control changesNo text-right" readonly autocomplete="off"  ondrop="return false;" onpaste="return false;">@(<span name="igstrate[]" id="igstrate_' + i + '"></span>)</td>';
    html += '<td class="cess"><input type="number" step="0.01" name="cess[]" id="cess_' + i + '" class="cessval form-control changesNo text-right" readonly autocomplete="off"  ondrop="return false;" onpaste="return false;">@(<span name="cessrate[]" id="cessrate_' + i + '"></span>)</td>';
    html += '<td><input type="hidden" name="GstRate[]" id="GstRate_' + i + '" class="form-control changesNo text-right" readonly autocomplete="off"  ondrop="return false;" onpaste="return false;"><input type="number" step="0.01" name="total[]" id="total_' + i + '" class="form-control totalLinePrice text-right" readonly autocomplete="off" ondrop="return false;" onpaste="return false;"></td>';
    html += '</tr>';
    $('table').append(html);
