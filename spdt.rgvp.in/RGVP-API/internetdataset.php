<?php include "include.php";// VARIABLES
                        $SelectColumns = array("ID","SourceID","Sourcename","Author","Title","Description","Url","UrlToImage","PublishedAt","Content","TopArticle","EngagementReactionCount","EngagementCommentCount","EngagementShareCount","EngagementCommentPluginCount"); // array("id", "name", "email", "mobile", "start_date");
                        $InsertColumns = array("SourceID","Sourcename","Author","Title","Description","Url","UrlToImage","PublishedAt","Content","TopArticle","EngagementReactionCount","EngagementCommentCount","EngagementShareCount","EngagementCommentPluginCount");
                        $UpdateColumns = array("SourceID","Sourcename","Author","Title","Description","Url","UrlToImage","PublishedAt","Content","TopArticle","EngagementReactionCount","EngagementCommentCount","EngagementShareCount","EngagementCommentPluginCount");
                        $InsertColumnsData = array("txt_SourceID","txt_Sourcename","txt_Author","txt_Title","txt_Description","txt_Url","txt_UrlToImage","datetime_PublishedAt","txt_Content","txt_TopArticle","txt_EngagementReactionCount","txt_EngagementCommentCount","txt_EngagementShareCount","txt_EngagementCommentPluginCount");
                        $ColumnAPIUpdateData = array("txt_SourceID","txt_Sourcename","txt_Author","txt_Title","txt_Description","txt_Url","txt_UrlToImage","datetime_PublishedAt","txt_Content","txt_TopArticle","txt_EngagementReactionCount","txt_EngagementCommentCount","txt_EngagementShareCount","txt_EngagementCommentPluginCount");
                        $InsertColDataString = "";
                        $UpdateColDataString = "";
                        $sIndexColumn = "ID";
                        $sTable = "internetdataset";
