...
$SelectColumns = array("DatasetID", "Name", "TableName", "RowsNum", "ColumnNum", "Description", "Attributes", "Output", "UpdateDate", "CreatedDate"); // array("id", "name", "email", "mobile", "start_date");
$InsertColumns = array("Name", "TableName", "RowsNum", "ColumnNum", "Description", "Attributes", "Output");
$UpdateColumns = array("Name", "TableName", "RowsNum", "ColumnNum", "Description", "Attributes", "Output");
$InsertColumnsData = array("txt_Name", "txt_TableName", "txt_RowsNum", "txt_ColumnNum", "txt_Description", "txt_Attributes", "txt_Output");
$ColumnAPIUpdateData = array("txt_Name", "txt_TableName", "txt_RowsNum", "txt_ColumnNum", "txt_Description", "txt_Attributes", "txt_Output");
$InsertColDataString = "";
$UpdateColDataString = "";
$sIndexColumn = "DatasetID";
$sTable = "Datasets";
...
switch ($CommandType) {
    ...
    case "SELECT":
        ...
        while ($aRow = mysqli_fetch_array($rResult)) {
            ...
            $output["data"][] = array_merge($row, array('<a href="' . $row[2] . '" class="btn btn-primary"><i class="fa fa-eye"></i></a>&nbsp;<a data-id="row-' . $row[0] . '" href="javascript:editRow(' . $row[0] . ');" class="btn btn-success"><i class="fa fa-edit"></i></a>&nbsp;<a href="javascript:removeRow(' . $row[0] . ');" class="btn btn-danger" ><i class="fa fa-close"></i></a>'), $row);
        }
        // RETURN IN JSON
