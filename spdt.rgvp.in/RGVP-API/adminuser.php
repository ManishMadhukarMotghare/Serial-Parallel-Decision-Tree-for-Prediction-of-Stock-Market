...
$SelectColumns = array("UserID", "Name", "Mobile", "Email", "Dob", "UserName", "Password", "UserType", "Status", "UpdateBy", "UpdateDate", "AddedBy", "AddedDate"); // array("id", "name", "email", "mobile", "start_date");
$InsertColumns = array("Name", "Mobile", "Email", "Dob", "UserName", "Password", "UserType", "Status", "UpdateBy", "AddedBy");
$UpdateColumns = array("Name", "Mobile", "Email", "Dob", "UserName", "Password", "UserType", "Status", "UpdateBy", "AddedBy");
$InsertColumnsData = array("txt_Name", "txt_Mobile", "txt_Email", "date_Dob", "txt_UserName", "txt_Password", "ddl_UserType", "ddl_Status", "txt_UpdateBy", "txt_AddedBy");
$ColumnAPIUpdateData = array("txt_Name", "txt_Mobile", "txt_Email", "date_Dob", "txt_UserName", "txt_Password", "ddl_UserType", "ddl_Status", "txt_UpdateBy", "txt_AddedBy");
$InsertColDataString = "";
$UpdateColDataString = "";
$sIndexColumn = "UserID";
$sTable = "adminuser";
