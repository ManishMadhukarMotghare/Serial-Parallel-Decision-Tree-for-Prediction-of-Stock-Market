<?php include "include.php";// VARIABLES
                        $SelectColumns = array("ID","FormattedDate","Summary","PrecipType","Temperature","ApparentTemperature","Humidity","WindSpeed","WindBearing","Visibility","LoudCover","Pressure","DailySummary"); // array("id", "name", "email", "mobile", "start_date");
                        $InsertColumns = array("FormattedDate","Summary","PrecipType","Temperature","ApparentTemperature","Humidity","WindSpeed","WindBearing","Visibility","LoudCover","Pressure","DailySummary");
                        $UpdateColumns = array("FormattedDate","Summary","PrecipType","Temperature","ApparentTemperature","Humidity","WindSpeed","WindBearing","Visibility","LoudCover","Pressure","DailySummary");
                        $InsertColumnsData = array("datetime_FormattedDate","txt_Summary","txt_PrecipType","txt_Temperature","txt_ApparentTemperature","txt_Humidity","txt_WindSpeed","txt_WindBearing","txt_Visibility","txt_LoudCover","txt_Pressure","txt_DailySummary");
                        $ColumnAPIUpdateData = array("datetime_FormattedDate","txt_Summary","txt_PrecipType","txt_Temperature","txt_ApparentTemperature","txt_Humidity","txt_WindSpeed","txt_WindBearing","txt_Visibility","txt_LoudCover","txt_Pressure","txt_DailySummary");
                        $InsertColDataString = "";
                        $UpdateColDataString = "";
                        $sIndexColumn = "ID";
                        $sTable = "weatherhistory";
