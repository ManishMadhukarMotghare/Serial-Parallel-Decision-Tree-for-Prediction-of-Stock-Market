...
$SelectColumns = array("ExpenseID", "Date", "Time", "Purpose", "Amount", "FromUser", "ToUser", "ExpenseType", "TransactionType", "FromAccount", "ToAccount", "InstructedBy", "PaymentStatus", "Status", "AddedBy", "AddedDate", "UpdateBy", "UpdatedDate"); // array("id", "name", "email", "mobile", "start_date");
$InsertColumns = array("Date", "Time", "Purpose", "Amount", "FromUser", "ToUser", "ExpenseType", "TransactionType", "FromAccount", "ToAccount", "InstructedBy", "PaymentStatus", "Status", "AddedBy", "UpdateBy");
$UpdateColumns = array("ExpenseID", "Date", "Time", "Purpose", "Amount", "FromUser", "ToUser", "ExpenseType", "TransactionType", "FromAccount", "ToAccount", "InstructedBy", "PaymentStatus", "Status", "AddedBy", "UpdateBy");
$InsertColumnsData = array("date_Date", "txt_Time", "txt_Purpose", "txt_Amount", "txt_FromUser", "txt_ToUser", "txt_ExpenseType", "ddl_TransactionType", "txt_FromAccount", "txt_ToAccount", "txt_InstructedBy", "ddl_PaymentStatus", "ddl_Status", "txt_AddedBy", "txt_UpdateBy");
$ColumnAPIUpdateData = array("txt_ExpenseID", "date_Date", "txt_Time", "txt_Purpose", "txt_Amount", "txt_FromUser", "txt_ToUser", "txt_ExpenseType", "ddl_TransactionType", "txt_FromAccount", "txt_ToAccount", "txt_InstructedBy", "ddl_PaymentStatus", "ddl_Status", "txt_AddedBy", "txt_UpdateBy");
$InsertColDataString = "";
$UpdateColDataString = "";
...
//            die(json_encode(mysqli_fetch_assoc($Sql_output)));
            header("location:../expenses-view.php?txt_id=" . $id . "&submit=submit&msg=Your Data Updated Successfully");
        }
        break;
    case "DELETE":
    ...
    case "SELECT":
        ...
        while ($aRow = mysqli_fetch_array($rResult)) {
            ...
            $output["data"][] = array_merge(array('<a href="expenses-view.php?txt_id=' . $row[0] . '" class="btn btn-warning" ><i class="fa fa-eye"></i></a>&nbsp;'), $row, $row);
        }
        // RETURN IN JSON
