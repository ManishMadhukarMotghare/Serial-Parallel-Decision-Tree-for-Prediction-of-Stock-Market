<?php include "include.php";// VARIABLES
                        $SelectColumns = array("UserRoleID","UserRole","AddedBy","Status","AddedDate","UpdateDate","UpdateBy"); // array("id", "name", "email", "mobile", "start_date");
                        $InsertColumns = array("UserRole","AddedBy","Status","UpdateBy");
                        $UpdateColumns = array("UserRole","AddedBy","Status","UpdateBy");
                        $InsertColumnsData = array("txt_UserRole","txt_AddedBy","ddl_Status","txt_UpdateBy");
                        $ColumnAPIUpdateData = array("txt_UserRole","txt_AddedBy","ddl_Status","txt_UpdateBy");
                        $InsertColDataString = "";
                        $UpdateColDataString = "";
