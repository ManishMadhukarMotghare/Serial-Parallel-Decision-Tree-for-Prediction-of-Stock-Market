...
$SelectColumns = array("PODID", "DrsNo", "DrsID", "DocketNo", "DocketID", "ReceiverName", "ReceiverPhone", "POD", "DeliveryDate","PODHandover", "Status", "AddedBy", "UpdateBy"); // array("id", "name", "email", "mobile", "start_date");
$InsertColumns = array("DrsNo", "DrsID", "DocketNo", "DocketID", "ReceiverName", "ReceiverPhone", "POD", "DeliveryDate","PODHandover","Status", "AddedBy", "UpdateBy");
$InsertColumnsDelivered = array("DrsNo", "DrsID", "DocketNo", "DocketID", "ReceiverName", "ReceiverPhone", "POD", "DeliveryDate", "PODHandover","Status", "AddedBy", "UpdateBy");
$InsertColumnsNotDelivered = array("DrsNo", "DrsID", "DocketNo", "DocketID", "ReceiverName", "ReceiverPhone", "POD", "DeliveryDate","PODHandover", "Status", "AddedBy", "UpdateBy");
$InsertColumnsDataNotDelivered = array("txt_DrsNo", "txt_DrsID", "txt_DocketNo", "txt_DocketID", "txt_ReceiverName1", "txt_ReceiverPhone", "txt_uploadfile", "txt_ClosingTime","txt_PODHandover", "txt_Status", "txt_AddedBy", "txt_UpdateBy");
$UpdateColumns = array("DrsNo", "DrsID", "DocketNo", "DocketID", "ReceiverName", "ReceiverPhone", "POD", "DeliveryDate","PODHandover", "Status", "AddedBy", "UpdateBy");
$UpdateColumnsDelivered = array("DrsNo", "DrsID", "DocketNo", "DocketID", "ReceiverName", "ReceiverPhone", "POD", "DeliveryDate","PODHandover", "Status");
$UpdateColumnsNotDelivered = array("DrsNo", "DrsID", "DocketNo", "DocketID", "ReceiverName", "ReceiverPhone", "POD", "DeliveryDate","PODHandover", "Status");
$UpdateColumnsDataDeliverd = array("txt_DrsNo", "txt_DrsID", "txt_DocketNo", "txt_DocketID", "txt_ReceiverName", "txt_ReceiverPhone", "txt_uploadfile", "txt_ClosingTime","txt_PODHandover", "txt_Status", "txt_AddedBy", "txt_UpdateBy");
$UpdateColumnsDataNotDeliverd = array("txt_DrsNo", "txt_DrsID", "txt_DocketNo", "txt_DocketID", "txt_ReceiverName", "txt_ReceiverPhone", "txt_uploadfile", "txt_ClosingTime","txt_PODHandover", "txt_Status", "txt_AddedBy", "txt_UpdateBy");
$InsertColumnsData = array("txt_DrsNo", "txt_DrsID", "txt_DocketNo", "txt_DocketID", "txt_ReceiverName", "txt_ReceiverPhone", "txt_uploadfile", "txt_ClosingTime","txt_PODHandover", "txt_Status", "txt_AddedBy", "txt_UpdateBy");
$InsertColumnsDataDelivered = array("txt_DrsNo", "txt_DrsID", "txt_DocketNo", "txt_DocketID", "txt_ReceiverName", "txt_ReceiverPhone", "txt_uploadfile", "txt_ClosingTime","txt_PODHandover", "txt_Status", "txt_AddedBy", "txt_UpdateBy");
$ColumnAPIUpdateData = array("txt_DrsNo", "txt_DrsID", "txt_DocketNo", "txt_DocketID", "txt_ReceiverName", "txt_ReceiverPhone", "txt_uploadfile", "txt_ClosingTime","txt_PODHandover", "txt_Status", "txt_AddedBy", "txt_UpdateBy");
$ColumnAPIUpdateDataNotDelivered = array("txt_DrsNo", "txt_DrsID", "txt_DocketNo", "txt_DocketID", "txt_ReceiverName1", "txt_ReceiverPhone", "txt_uploadfile", "txt_ClosingTime","txt_PODHandover", "txt_Status", "txt_AddedBy", "txt_UpdateBy");
$InsertColDataString = "";
$UpdateColDataString = "";
$sIndexColumn = "PODID";
$sTable = "pod";
...
//                                    $Sql_input = "INSERT INTO $sTable (".implode(",", $InsertColumns).") VALUES ($InsertColDataString)";
    ...
    case "SELECT":
        ...
        //echo "";
        break;
    case "SELECT-PFN-BRANCH":
        $sWhere = "";
        $sOrder = "order by docket.DocketDate desc";
        $sLimit = "";

        if (isset($posted["FromBranch"]) && isset($posted["ToBranch"])) {
            $sWhere = "Where docket.FromBranch = '" . $posted["FromBranch"] . "' and docket.ToBranch ='" . $posted['ToBranch'] . "' and pod.PODHandover='No'";
        }

        // FETCH
        $sQueryDisplay = "";
        $sQuery = "SELECT docket.DocketID, pod.DocketID,docket.DocketID,docket.DocketNumber,docket.DocketDate,docket.FromBranch,docket.ToBranch,
            docket.QTY,docket.ChargedWeight,docket.GrandTotal FROM docket INNER JOIN pod
                ON docket.DocketID = pod.DocketID $sWhere $sOrder $sLimit";
        $sQueryDisplay .= $sQuery . "\n";
        $rResult = $RGVP->DB->Execute_Query($sQuery, "GET", "SQLObj");
        $sQuery = " SELECT COUNT(" . $sIndexColumn . ") FROM $sTable ";
        $sQueryDisplay .= $sQuery . "\n";
