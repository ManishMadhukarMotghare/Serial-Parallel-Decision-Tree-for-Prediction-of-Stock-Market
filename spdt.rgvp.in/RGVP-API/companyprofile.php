<?php include "include.php";// VARIABLES
                        $SelectColumns = array("CPID","Name","Email","Mobile","Address","PhoneNo","ImageLogo","BranchCity","GSTIN","PANCardNo","CINNo","StateCode","Note","Status","Offer","UpdateBy","UpdateDate","AddedBy","AddedDate"); // array("id", "name", "email", "mobile", "start_date");
                        $InsertColumns = array("Name","Email","Mobile","Address","PhoneNo","ImageLogo","BranchCity","GSTIN","PANCardNo","CINNo","StateCode","Note","Status","Offer","UpdateBy","AddedBy");
                        $UpdateColumns = array("Name","Email","Mobile","Address","PhoneNo","ImageLogo","BranchCity","GSTIN","PANCardNo","CINNo","StateCode","Note","Status","Offer","UpdateBy","AddedBy");
                        $InsertColumnsData = array("txt_Name","txt_Email","txt_Mobile","txt_Address","txt_PhoneNo","txt_ImageLogo","txt_BranchCity","txt_GSTIN","txt_PANCardNo","txt_CINNo","txt_StateCode","txt_Note","ddl_Status","ddl_Offer","txt_UpdateBy","txt_AddedBy");
                        $ColumnAPIUpdateData = array("txt_Name","txt_Email","txt_Mobile","txt_Address","txt_PhoneNo","txt_ImageLogo","txt_BranchCity","txt_GSTIN","txt_PANCardNo","txt_CINNo","txt_StateCode","txt_Note","ddl_Status","ddl_Offer","txt_UpdateBy","txt_AddedBy");
                        $InsertColDataString = "";
                        $UpdateColDataString = "";
                        $sIndexColumn = "";
                        $sTable = "companyprofile";
