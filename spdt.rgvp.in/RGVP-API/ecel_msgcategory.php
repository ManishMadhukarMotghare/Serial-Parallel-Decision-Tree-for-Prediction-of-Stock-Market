<?php include "include.php";// VARIABLES
                        $SelectColumns = array("MsgCategoryID","Name","Alias","UpdateBy","UpdateDate","AddedBy","AddedDate"); // array("id", "name", "email", "mobile", "start_date");
                        $InsertColumns = array("Name","Alias","UpdateBy","AddedBy");
                        $UpdateColumns = array("Name","Alias","UpdateBy","AddedBy");
                        $InsertColumnsData = array("txt_Name","txt_Alias","txt_UpdateBy","txt_AddedBy");
                        $ColumnAPIUpdateData = array("txt_Name","txt_Alias","txt_UpdateBy","txt_AddedBy");
                        $InsertColDataString = "";
                        $UpdateColDataString = "";
                        $sIndexColumn = "MsgCategoryID";
                        $sTable = "ecel_msgcategory";
