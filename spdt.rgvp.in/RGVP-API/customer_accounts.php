...
$SelectColumns = array("CAID", "CustomerID", "Branch_code", "Date_Transaction", "Transaction_type", "Transaction_mode", "TransactionDate", "TransactionID", "TransactionAmount", "Status","Narration","Remark", "AddedBy", "AddedDate", "UpdateBy", "UpdatedDate"); // array("id", "name", "email", "mobile", "start_date");
$InsertColumns = array("CustomerID", "Branch_code", "Date_Transaction", "Transaction_type", "Transaction_mode", "TransactionDate", "TransactionID", "TransactionAmount", "Status", "AddedBy", "UpdateBy");
$UpdateColumns = array("CustomerID", "Branch_code", "Date_Transaction", "Transaction_type", "Transaction_mode", "TransactionDate", "TransactionID", "TransactionAmount","Narration","Remark", "Status", "AddedBy", "UpdateBy");
$InsertColumnsData = array("txt_CustomerID", "txt_Branch_code", "date_Date_Transaction", "ddl_Transaction_type", "ddl_Transaction_mode", "date_TransactionDate", "txt_TransactionID", "txt_TransactionAmount", "ddl_Status","txt_AddedBy", "txt_UpdateBy");
$ColumnAPIUpdateData = array("txt_CustomerID", "txt_Branch_code", "date_Date_Transaction", "ddl_Transaction_type", "ddl_Transaction_mode", "date_TransactionDate", "txt_TransactionID", "txt_TransactionAmount", "ddl_Status","txt_Narration","txt_Remark", "txt_AddedBy", "txt_UpdateBy");
$InsertColDataString = "";
$UpdateColDataString = "";
$sIndexColumn = "CAID";
$sTable = "customer_accounts";
...
//            die(json_encode(mysqli_fetch_assoc($Sql_output)));
            header("location:../customer-view.php?txt_id=" . $ID . "&btnSearch=Search");
        }
        break;
    case "UPDATE-SAVE":
    ...
    case "SELECT":
        ...
        while ($aRow = mysqli_fetch_array($rResult)) {
            ...
            $output["data"][] = array_merge(array('<a data-id="row-' . $row[0] . '" href="javascript:editRowAccount(' . $row[0] . ');" class="btn btn-success"><i class="fa fa-edit"></i></a>&nbsp;<a href="javascript:removeRowAccount(' . $row[0] . ');" class="btn btn-danger" ><i class="fa fa-close"></i></a>'), $row);
        }
        // RETURN IN JSON
