...
$SelectColumns = array("ExpenseID", "Date", "Time", "Purpose", "Amount", "FromUser", "ToUser", "ExpenseType", "TransactionType", "FromAccount", "ToAccount", "InstructedBy", "PaymentStatus", "CompanyID", "Status", "AddedBy", "AddedDate", "UpdateBy", "UpdatedDate"); // array("id", "name", "email", "mobile", "start_date");
$InsertColumns = array("Date", "Time", "Purpose", "Amount", "FromUser", "ToUser", "ExpenseType", "TransactionType", "FromAccount", "ToAccount", "InstructedBy", "PaymentStatus", "CompanyID", "Status", "AddedBy", "UpdateBy");
$UpdateColumns = array("ExpenseID", "Date", "Time", "Purpose", "Amount", "FromUser", "ToUser", "ExpenseType", "TransactionType", "FromAccount", "ToAccount", "InstructedBy", "PaymentStatus", "CompanyID", "Status", "AddedBy", "UpdateBy");
$InsertColumnsData = array("date_Date", "txt_Time", "txt_Purpose", "txt_Amount", "txt_FromUser", "txt_ToUser", "txt_ExpenseType", "ddl_TransactionType", "txt_FromAccount", "txt_ToAccount", "txt_InstructedBy", "ddl_PaymentStatus", "txt_CompanyID", "ddl_Status", "txt_AddedBy", "txt_UpdateBy");
$ColumnAPIUpdateData = array("txt_ExpenseID", "date_Date", "txt_Time", "txt_Purpose", "txt_Amount", "txt_FromUser", "txt_ToUser", "txt_ExpenseType", "ddl_TransactionType", "txt_FromAccount", "txt_ToAccount", "txt_InstructedBy", "ddl_PaymentStatus", "txt_CompanyID", "ddl_Status", "txt_AddedBy", "txt_UpdateBy");
$InsertColDataString = "";
$UpdateColDataString = "";
...
//            die(json_encode(mysqli_fetch_assoc($Sql_output)));
        ...
        header("location:../view-expenses.php?txt_id=$id");
        break;
    case "UPDATE-SAVE":
...
//            die(json_encode(mysqli_fetch_assoc($Sql_output)));
        } header("location:../view-expenses.php?txt_id=" . $id . "&submit=submit&msg=Your Data Updated Successfully");
        break;
    case "DELETE":
        ...
        if (isset($_GET["id"]) && 0 < intval($_GET["id"])) {
            //dbinit($gaSql);
            // REMOVE DATA
            $Sql_input = "update expenses set Status='Inactive' WHERE $sIndexColumn = " . intval($_GET["id"]);
    ...
    case "SELECT":
        ...
        while ($aRow = mysqli_fetch_array($rResult)) {
            ...
            $output["data"][] = array_merge(array('<a href="view-expenses.php?txt_id=' . $row[0] . '" class="btn btn-warning" ><i class="fa fa-eye"></i></a>&nbsp;'), $row, $row);
        }
        // RETURN IN JSON
