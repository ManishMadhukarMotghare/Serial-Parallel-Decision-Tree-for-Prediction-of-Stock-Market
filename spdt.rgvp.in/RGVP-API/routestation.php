...
$SelectColumns = array("RoutestationID", "RouteID", "StationName", "Order", "AddedBy", "AddedDate", "UpdateBy", "UpdateDate"); // array("id", "name", "email", "mobile", "start_date");
$InsertColumns = array("RouteID", "StationName", "Order", "AddedBy", "UpdateBy");
$UpdateColumns = array("RouteID", "StationName", "Order", "AddedBy", "UpdateBy");
$InsertColumnsData = array("txt_RouteID", "txt_StationName", "txt_Order", "txt_AddedBy", "txt_UpdateBy");
$ColumnAPIUpdateData = array("txt_RouteID", "txt_StationName", "txt_Order", "txt_AddedBy", "txt_UpdateBy");
$InsertColDataString = "";
$UpdateColDataString = "";
$sIndexColumn = "RoutestationID";
$sTable = "routestation";
...
switch ($CommandType) {
    ...
    case "DELETE":
        ...
        if (isset($_GET["id"]) && 0 < intval($_GET["id"])) {
            //dbinit($gaSql);
            // REMOVE DATA
            $Sql_input = "update routestation set Status='Inactive' WHERE $sIndexColumn = " . intval($_GET["id"]);
    ...
    case "SELECT":
        ...
        while ($aRow = mysqli_fetch_array($rResult)) {
            ...
            $output["data"][] = array_merge($row, array('<a data-id="row-' . $row[0] . '" href="javascript:editRowRouteStation(' . $row[0] . ');" class="btn btn-success"><i class="fa fa-edit"></i></a>&nbsp;<a href="javascript:removeRowRouteStation(' . $row[0] . ');" class="btn btn-danger" ><i class="fa fa-close"></i></a>'), $row);
        }
        // RETURN IN JSON
