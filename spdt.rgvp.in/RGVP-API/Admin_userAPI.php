...
//            die(json_encode(mysqli_fetch_assoc($Sql_output)));
            header("location:../adminuser-view.php?txt_id=" . $id . "&btnSearch=Search&Msg=Your Data is Updated Succesfully");
        }
    ...
    case "SELECT":
        ...
        while ($aRow = mysqli_fetch_array($rResult)) {
            ...
            $output["data"][] = array_merge(array('<a href="adminuser-view.php?txt_id=' . $row[0] . '" class="btn btn-warning" ><i class="fa fa-eye"></i></a>'), $row);
        }
        // RETURN IN JSON
