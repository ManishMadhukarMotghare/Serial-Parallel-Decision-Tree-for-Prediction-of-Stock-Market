...
$SelectColumns = array("BranchTargetsID", "BranchID", "BranchCode", "Month", "Year", "TargetDocket", "TargetWt", "TargetRevenue", "AddedBy", "AddedDate", "UpdateBy", "UpdatedDate"); // array("id", "name", "email", "mobile", "start_date");
$InsertColumns = array("BranchID", "BranchCode", "Month", "Year", "TargetDocket", "TargetWt", "TargetRevenue","AddedBy", "UpdateBy", "UpdatedDate");
$UpdateColumns = array("BranchID", "BranchCode", "Month", "Year", "TargetDocket", "TargetWt", "TargetRevenue", "AddedBy", "UpdateBy");
$InsertColumnsData = array("txt_BranchID", "txt_BranchCode", "ddl_Month", "ddl_Year", "txt_TargetDocket", "txt_TargetWt","txt_TargetRevenue", "txt_AddedBy", "txt_UpdateBy", "txt_UpdatedDate");
$ColumnAPIUpdateData = array("txt_BranchID", "txt_BranchCode", "ddl_Month", "ddl_Year", "txt_TargetDocket", "txt_TargetWt", "txt_TargetRevenue", "txt_AddedBy", "txt_UpdateBy");
$InsertColDataString = "";
$UpdateColDataString = "";
$sIndexColumn = "BranchTargetsID";
$sTable = "branchtargets";
...
switch ($CommandType) {
    ...
    case "SELECT":
        ...
        if (isset($_GET["BranchID"]))
            if ($sWhere == "")
                $sWhere = " WHERE BranchID = " . $_GET["BranchID"];
            else
                $sWhere .= " AND BranchID = " . $_GET["BranchID"];
        $sQueryDisplay = "";
