...
$SelectColumns = array("CompanyID", "CompanyName", "CompanyDetails", "CompanyCode", "CompanyBillingAddress", "BillingPincode", "BillingCity", "BillingState", "BillingCountry", "CompanyShippingAddress", "ShippingPincode", "ShippingCity", "ShippingState", "ShippingCountry", "CompanyEmail", "CompanyWebsite", "CompanyPhone", "CompanyMobile", "CompanyGSTINNO", "CompanyPAN", "PlaceOfSupply", "AccountType", "BankName", "BranchName", "IFSCCode", "BankAccountNo", "CompanyFootNote1", "CompanyFootNote2", "CompanyValidity", "Status", "AddedBy", "AddedDate", "UpadtedBy", "UpdatedDate"); // array("id", "name", "email", "mobile", "start_date");
$InsertColumns = array("CompanyName", "CompanyDetails", "CompanyCode", "CompanyBillingAddress", "BillingPincode", "BillingCity", "BillingState", "BillingCountry", "CompanyShippingAddress", "ShippingPincode", "ShippingCity", "ShippingState", "ShippingCountry", "CompanyEmail", "CompanyWebsite", "CompanyPhone", "CompanyMobile", "CompanyGSTINNO", "CompanyPAN", "PlaceOfSupply", "AccountType", "BankName", "BranchName", "IFSCCode", "BankAccountNo", "CompanyFootNote1", "CompanyFootNote2", "CompanyValidity", "Status", "AddedBy", "UpadtedBy");
$UpdateColumns = array("CompanyName", "CompanyDetails", "CompanyCode", "CompanyBillingAddress", "BillingPincode", "BillingCity", "BillingState", "BillingCountry", "CompanyShippingAddress", "ShippingPincode", "ShippingCity", "ShippingState", "ShippingCountry", "CompanyEmail", "CompanyWebsite", "CompanyPhone", "CompanyMobile", "CompanyGSTINNO", "CompanyPAN", "PlaceOfSupply", "AccountType", "BankName", "BranchName", "IFSCCode", "BankAccountNo", "CompanyFootNote1", "CompanyFootNote2", "CompanyValidity", "Status", "AddedBy", "UpadtedBy");
$InsertColumnsData = array("txt_CompanyName", "txt_CompanyDetails", "txt_CompanyCode", "txt_CompanyBillingAddress", "txt_BillingPincode", "txt_BillingCity", "txt_BillingState", "txt_BillingCountry", "txt_CompanyShippingAddress", "txt_ShippingPincode", "txt_ShippingCity", "txt_ShippingState", "txt_ShippingCountry", "txt_CompanyEmail", "txt_CompanyWebsite", "txt_CompanyPhone", "txt_CompanyMobile", "txt_CompanyGSTINNO", "txt_CompanyPAN", "txt_PlaceOfSupply", "ddl_AccountType", "txt_BankName", "txt_BranchName", "txt_IFSCCode", "txt_BankAccountNo", "txt_CompanyFootNote1", "txt_CompanyFootNote2", "date_CompanyValidity", "ddl_Status", "txt_AddedBy", "txt_UpadtedBy");
$ColumnAPIUpdateData = array("txt_CompanyName", "txt_CompanyDetails", "txt_CompanyCode", "txt_CompanyBillingAddress", "txt_BillingPincode", "txt_BillingCity", "txt_BillingState", "txt_BillingCountry", "txt_CompanyShippingAddress", "txt_ShippingPincode", "txt_ShippingCity", "txt_ShippingState", "txt_ShippingCountry", "txt_CompanyEmail", "txt_CompanyWebsite", "txt_CompanyPhone", "txt_CompanyMobile", "txt_CompanyGSTINNO", "txt_CompanyPAN", "txt_PlaceOfSupply", "ddl_AccountType", "txt_BankName", "txt_BranchName", "txt_IFSCCode", "txt_BankAccountNo", "txt_CompanyFootNote1", "txt_CompanyFootNote2", "date_CompanyValidity", "ddl_Status", "txt_AddedBy", "txt_UpadtedBy");
$InsertColDataString = "";
$UpdateColDataString = "";
...
switch ($CommandType) {
    ...
    case "UPDATE-SAVE":
        ...
        if (isset($_GET["id"]) && 0 < intval($_GET["id"])) {
         ...
         case "UPDATE":
        // AJAX EDIT FROM JQUERY
        $CompanyID = $_REQUEST['txt_CompanyID'];
        // SAVE DATA
        for ($j = 0; $j < count($ColumnAPIUpdateData); $j++)
            $UpdateColDataString .= $UpdateColumns[$j] . " = '" . $posted[$ColumnAPIUpdateData[$j]] . "',";
        $UpdateColDataString = substr($UpdateColDataString, 0, strlen($UpdateColDataString) - 1);
        $Sql_input = " UPDATE $sTable SET $UpdateColDataString WHERE CompanyID = $CompanyID;";
        $Sql_output = $RGVP->DB->Execute_Query($Sql_input, "SET", "UPDATE");
        header("Location:../company-view.php?msg=Company Detais has been Updated Successfully.");
    ...
    case "SELECT":
        ...
        while ($aRow = mysqli_fetch_array($rResult)) {
            ...
            $output["data"][] = array_merge(array('<a data-id="row-' . $row[0] . '" href="javascript:editRow(' . $row[0] . ');" class="btn btn-success"><i class="fa fa-edit"></i></a>&nbsp;<a href="javascript:removeRow(' . $row[0] . ');" class="btn btn-danger" ><i class="fa fa-close"></i></a>'), $row);
        }
        // RETURN IN JSON
