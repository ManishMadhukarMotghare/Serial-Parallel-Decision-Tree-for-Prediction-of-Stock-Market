    ...
    case "INSERT":
        ...
        if (isset($_REQUEST)) {
            ...
            if ($RGVP->DB->StatusCode == "502") {
                ...
                $thcnumber = $posted["ddl_THCType"]."/" . $posted["txt_FromBranch"] . "/" . $id . "";
