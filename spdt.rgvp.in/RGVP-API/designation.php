<?php include "include.php";// VARIABLES
                        $SelectColumns = array("DesignationID","Designation","Status","UpdateBy","UpdatedDate","AddedBy","AddedDate"); // array("id", "name", "email", "mobile", "start_date");
                        $InsertColumns = array("Designation","Status","UpdateBy","AddedBy");
                        $UpdateColumns = array("Designation","Status","UpdateBy","AddedBy");
                        $InsertColumnsData = array("txt_Designation","ddl_Status","txt_UpdateBy","txt_AddedBy");
                        $ColumnAPIUpdateData = array("txt_Designation","ddl_Status","txt_UpdateBy","txt_AddedBy");
                        $InsertColDataString = "";
                        $UpdateColDataString = "";
