<?php include "include.php";// VARIABLES
                        $SelectColumns = array("DepartmentID","DepartmentName","Status","UpdateBy","UpdateDate","AddedBy","AddedDate"); // array("id", "name", "email", "mobile", "start_date");
                        $InsertColumns = array("DepartmentName","Status","UpdateBy","AddedBy");
                        $UpdateColumns = array("DepartmentName","Status","UpdateBy","UpdateDate","AddedBy");
                        $InsertColumnsData = array("txt_DepartmentName","ddl_Status","txt_UpdateBy","txt_AddedBy");
                        $ColumnAPIUpdateData = array("txt_DepartmentName","ddl_Status","txt_UpdateBy","datetime_UpdateDate","txt_AddedBy");
                        $InsertColDataString = "";
                        $UpdateColDataString = "";
