<?php include "include.php";// VARIABLES
                        $SelectColumns = array("UserRoleID","UserRole","Status","AddedBy","AddedDate","UpdateBy","UpdateDate"); // array("id", "name", "email", "mobile", "start_date");
                        $InsertColumns = array("UserRole","Status","AddedBy","UpdateBy");
                        $UpdateColumns = array("UserRole","Status","AddedBy","UpdateBy");
                        $InsertColumnsData = array("txt_UserRole","ddl_Status","txt_AddedBy","txt_UpdateBy");
                        $ColumnAPIUpdateData = array("txt_UserRole","ddl_Status","txt_AddedBy","txt_UpdateBy");
                        $InsertColDataString = "";
                        $UpdateColDataString = "";
                        $sIndexColumn = "UserRoleID";
                        $sTable = "user_role";
