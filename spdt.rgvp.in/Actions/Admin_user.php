...
$SelectColumns = array("userID", "Name", "Mobile", "Email", "Dob", "UserType", "Username", "Password", "Status", "AddedBy", "AddedDate", "UpdateBy", "UpdatedDate"); // array("id", "name", "email", "mobile", "start_date");
$InsertColumns = array("Name", "Mobile", "Email", "Dob", "UserType", "Username", "Password", "Status", "AddedBy", "UpdateBy");
$UpdateColumns = array("Name", "Mobile", "Email", "Dob", "UserType", "Username", "Password", "Status", "AddedBy", "UpdateBy");
$InsertColumnsData = array("txt_Name", "txt_Mobile", "txt_Email", "date_Dob", "txt_UserType", "txt_Username", "txt_Password", "txt_Status", "txt_AddedBy", "txt_UpdateBy");
$ColumnAPIUpdateData = array("txt_Name", "txt_Mobile", "txt_Email", "date_Dob", "txt_UserType", "txt_Username", "txt_Password", "txt_Status", "txt_AddedBy", "txt_UpdateBy");
$InsertColDataString = "";
$UpdateColDataString = "";
$sIndexColumn = "userID";
$sTable = "Admin_user";
