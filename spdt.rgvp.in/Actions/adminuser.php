<?php include "include.php";// VARIABLES
                        $SelectColumns = array("UserID","Name","Mobile","Email","Dob","Department","UserType","UserName","Password","Status","CreateDate"); // array("id", "name", "email", "mobile", "start_date");
                        $InsertColumns = array("Name","Mobile","Email","Dob","Department","UserType","UserName","Password","Status");
                        $UpdateColumns = array("Name","Mobile","Email","Dob","Department","UserType","UserName","Password","Status");
                        $InsertColumnsData = array("txt_Name","txt_Mobile","txt_Email","date_Dob","txt_Department","ddl_UserType","txt_UserName","txt_Password","txt_Status");
                        $ColumnAPIUpdateData = array("txt_Name","txt_Mobile","txt_Email","date_Dob","txt_Department","ddl_UserType","txt_UserName","txt_Password","txt_Status");
                        $InsertColDataString = "";
                        $UpdateColDataString = "";
                        $sIndexColumn = "UserID";
                        $sTable = "adminuser";
