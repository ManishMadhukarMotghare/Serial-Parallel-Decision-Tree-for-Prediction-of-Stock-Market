<?php include "include.php";// VARIABLES
                        $SelectColumns = array("DesignationID","Designation","AddedBy","Status","AddedDate","UpdateDate","UpdateBy"); // array("id", "name", "email", "mobile", "start_date");
                        $InsertColumns = array("Designation","AddedBy","Status","UpdateBy");
                        $UpdateColumns = array("Designation","AddedBy","Status","UpdateBy");
                        $InsertColumnsData = array("txt_Designation","txt_AddedBy","ddl_Status","txt_UpdateBy");
                        $ColumnAPIUpdateData = array("txt_Designation","txt_AddedBy","ddl_Status","txt_UpdateBy");
                        $InsertColDataString = "";
                        $UpdateColDataString = "";
